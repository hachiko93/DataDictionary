...
public class Field_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_s65pvt_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Field_Editor.domainSingleRoleHandler_s65pvt_c0(node, MetaAdapterFactory.getContainmentLink(0xbf590b41a0a34576L, 0x9cd0dea0bf554be3L, 0x15def33a0dfb8bd3L, 0x6855f68baae95d56L, "domain"), editorContext);
    return provider.createCell();
  }
  private class domainSingleRoleHandler_s65pvt_c0 extends SingleRoleCellProvider {
    public domainSingleRoleHandler_s65pvt_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
