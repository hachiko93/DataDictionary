...
public class AbstractStructure_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_t5y9el_a(editorContext, node);
  }
  private EditorCell createCollection_t5y9el_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_t5y9el_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createRefNode_t5y9el_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_t5y9el_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new AbstractStructure_Editor.structureSingleRoleHandler_t5y9el_a0(node, MetaAdapterFactory.getContainmentLink(0xbf590b41a0a34576L, 0x9cd0dea0bf554be3L, 0x15def33a0dfb8be6L, 0x6855f68baae98b3aL, "structure"), editorContext);
    return provider.createCell();
  }
  private class structureSingleRoleHandler_t5y9el_a0 extends SingleRoleCellProvider {
    public structureSingleRoleHandler_t5y9el_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
