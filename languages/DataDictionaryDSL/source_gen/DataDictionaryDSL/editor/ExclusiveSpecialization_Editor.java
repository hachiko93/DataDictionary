...
public class ExclusiveSpecialization_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_o85bht_c0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_o85bht_a2a(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_o85bht_a2a(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new ExclusiveSpecialization_Editor.structureSingleRoleHandler_o85bht_a2a(node, MetaAdapterFactory.getContainmentLink(0xbf590b41a0a34576L, 0x9cd0dea0bf554be3L, 0x15def33a0dfb8be6L, 0x6855f68baae98b3aL, "structure"), editorContext);
    return provider.createCell();
  }
  private class structureSingleRoleHandler_o85bht_a2a extends SingleRoleCellProvider {
    public structureSingleRoleHandler_o85bht_a2a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
